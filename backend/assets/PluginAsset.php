...
class PluginAsset extends AssetBundle
{
    ...
    {
        return self::$pluginMap[$name] ? self::$pluginMap[$name] :  (\Yii::$app->params['hail812/yii2-adminlte3']['pluginMap'][$name] ? \Yii::$app->params['hail812/yii2-adminlte3']['pluginMap'][$name] : null);
    }
}