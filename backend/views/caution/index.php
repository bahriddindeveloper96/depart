        ...
        'columns' => [
            ...
            [
                ...
                'value' => function (Instruction $model) {
                    return $model->cautionCompany ? $model->cautionCompany->region->name : '';
                },
            ...
            [
                ...
                'label' => 'Xyus nomi',
                'value' => function (Instruction $model) {
                    return $model->cautionCompany ? $model->cautionCompany->name : '';
                },
            ...
            [
                ...
                'label' => 'Xyus inn',
                'value' => function (Instruction $model) {
                    return $model->cautionCompany ? $model->cautionCompany->inn : '';
                },
